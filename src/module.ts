...
import { esToolkitArray, esToolkitFunction, esToolkitMath, esToolkitObject, esToolkitPredicate, esToolkitPromise, esToolkitString, esToolkitUtil } from './runtime/es-toolkit/index'
import { firstLetterToUpperCase } from './utils'

type Utilities = 'array' | 'function' | 'math' | 'object' | 'predicate' | 'promise' | 'string' | 'util'
